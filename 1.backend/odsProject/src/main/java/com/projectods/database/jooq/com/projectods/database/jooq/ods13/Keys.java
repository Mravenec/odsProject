...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds13Record, UsuariosRecord> AUDITORIA_ODS13_IBFK_1 = Internal.createForeignKey(AuditoriaOds13.AUDITORIA_ODS13, DSL.name("auditoria_ods13_ibfk_1"), new TableField[] { AuditoriaOds13.AUDITORIA_ODS13.USUARIO_ID }, com.projectods.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
