...
public class Sesiones extends TableImpl<SesionesRecord> {
     ...
     */
    public final TableField<SesionesRecord, String> USER_AGENT = createField(DSL.name("user_agent"), SQLDataType.CLOB.defaultValue(DSL.field(DSL.raw("NULL"), SQLDataType.CLOB)), this, "");
    ...
    public List<UniqueKey<SesionesRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_SESIONES_SESSION_TOKEN, Keys.KEY_SESIONES_REFRESH_TOKEN);
    }
