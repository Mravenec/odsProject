 ...
 */
package database.jooq.ods12;


import database.jooq.ods12.tables.AuditoriaOds12;
import database.jooq.ods12.tables.Indicadores;
import database.jooq.ods12.tables.MedicionesHistoricas;
import database.jooq.ods12.tables.MetasProyecto;
...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds12Record, UsuariosRecord> AUDITORIA_ODS12_IBFK_1 = Internal.createForeignKey(AuditoriaOds12.AUDITORIA_ODS12, DSL.name("auditoria_ods12_ibfk_1"), new TableField[] { AuditoriaOds12.AUDITORIA_ODS12.USUARIO_ID }, database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
