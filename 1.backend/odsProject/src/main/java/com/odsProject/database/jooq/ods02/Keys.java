 ...
 */
package database.jooq.ods02;


import database.jooq.ods02.tables.AuditoriaOds02;
import database.jooq.ods02.tables.Indicadores;
import database.jooq.ods02.tables.MedicionesHistoricas;
import database.jooq.ods02.tables.MetasProyecto;
...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds02Record, UsuariosRecord> AUDITORIA_ODS02_IBFK_1 = Internal.createForeignKey(AuditoriaOds02.AUDITORIA_ODS02, DSL.name("auditoria_ods02_ibfk_1"), new TableField[] { AuditoriaOds02.AUDITORIA_ODS02.USUARIO_ID }, database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
