...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds07Record, UsuariosRecord> AUDITORIA_ODS07_IBFK_1 = Internal.createForeignKey(AuditoriaOds07.AUDITORIA_ODS07, DSL.name("auditoria_ods07_ibfk_1"), new TableField[] { AuditoriaOds07.AUDITORIA_ODS07.USUARIO_ID }, database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
