...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds17Record, UsuariosRecord> AUDITORIA_ODS17_IBFK_1 = Internal.createForeignKey(AuditoriaOds17.AUDITORIA_ODS17, DSL.name("auditoria_ods17_ibfk_1"), new TableField[] { AuditoriaOds17.AUDITORIA_ODS17.USUARIO_ID }, database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
