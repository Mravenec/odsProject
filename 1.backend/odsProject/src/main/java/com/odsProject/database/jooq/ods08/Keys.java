...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds08Record, UsuariosRecord> AUDITORIA_ODS08_IBFK_1 = Internal.createForeignKey(AuditoriaOds08.AUDITORIA_ODS08, DSL.name("auditoria_ods08_ibfk_1"), new TableField[] { AuditoriaOds08.AUDITORIA_ODS08.USUARIO_ID }, database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
