 ...
 */
package odsProject.database.jooq.ods09;


import odsProject.database.jooq.ods09.tables.AuditoriaOds09;
import odsProject.database.jooq.ods09.tables.Indicadores;
import odsProject.database.jooq.ods09.tables.MedicionesHistoricas;
import odsProject.database.jooq.ods09.tables.MetasProyecto;
...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds09Record, UsuariosRecord> AUDITORIA_ODS09_IBFK_1 = Internal.createForeignKey(AuditoriaOds09.AUDITORIA_ODS09, DSL.name("auditoria_ods09_ibfk_1"), new TableField[] { AuditoriaOds09.AUDITORIA_ODS09.USUARIO_ID }, odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
