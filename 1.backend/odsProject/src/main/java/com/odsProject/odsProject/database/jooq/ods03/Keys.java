...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds03Record> KEY_AUDITORIA_ODS03_PRIMARY = Internal.createUniqueKey(AuditoriaOds03.AUDITORIA_ODS03, DSL.name("KEY_auditoria_ods03_PRIMARY"), new TableField[] { AuditoriaOds03.AUDITORIA_ODS03.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds03Record, UsuariosRecord> AUDITORIA_ODS03_IBFK_1 = Internal.createForeignKey(AuditoriaOds03.AUDITORIA_ODS03, DSL.name("auditoria_ods03_ibfk_1"), new TableField[] { AuditoriaOds03.AUDITORIA_ODS03.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
