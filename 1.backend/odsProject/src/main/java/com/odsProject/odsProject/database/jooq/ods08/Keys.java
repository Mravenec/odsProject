...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds08Record> KEY_AUDITORIA_ODS08_PRIMARY = Internal.createUniqueKey(AuditoriaOds08.AUDITORIA_ODS08, DSL.name("KEY_auditoria_ods08_PRIMARY"), new TableField[] { AuditoriaOds08.AUDITORIA_ODS08.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds08Record, UsuariosRecord> AUDITORIA_ODS08_IBFK_1 = Internal.createForeignKey(AuditoriaOds08.AUDITORIA_ODS08, DSL.name("auditoria_ods08_ibfk_1"), new TableField[] { AuditoriaOds08.AUDITORIA_ODS08.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
