...
import static com.odsProject.odsProject.database.jooq.ods16.tables.Indicadores.INDICADORES;
import static com.odsProject.odsProject.database.jooq.ods16.tables.Proyectos.PROYECTOS;
import static com.odsProject.odsProject.database.jooq.ods16.tables.MetasProyecto.METAS_PROYECTO;
...
public class Objetivo16PazJusticiaRepository implements IObjetivo16PazJusticiaRepository {
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_1_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.1.1"))
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_1_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.1.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_1_3(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.1.3"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_1_4(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.1.4"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_2_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.2.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_2_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.2.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_2_3(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.2.3"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_3_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.3.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_3_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.3.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_3_3(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.3.3"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_4_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.4.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_4_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.4.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_5_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.5.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_5_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.5.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_6_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.6.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_6_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.6.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_7_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.7.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_7_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.7.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_8_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.8.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_9_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.9.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_10_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.10.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_10_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.10.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_a_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.a.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_16_b_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("16.b.1"))
                .fetchOptionalInto(Indicadores.class);
    }
    ...
    public List<Indicadores> findAllIndicadoresByProyectoOds16(Integer proyectoId) {
        ...
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.like("16.%"))
    ...
    public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of(
            "status", "executed",
            "message", "Dashboard procedure executed for ODS16"
        );
    }
     ...
     */
    @Override
    public List<MetasProyecto> findAllMetasProyectoOds16(Integer proyectoId) {
        return dsl.selectFrom(METAS_PROYECTO)
                .where(METAS_PROYECTO.PROYECTO_ID.eq(proyectoId))
                .fetchInto(MetasProyecto.class);
    }
     ...
     */
    @Override
    public Optional<MetasProyecto> findMetaProyectoOds16ById(Integer metaId) {
        return dsl.selectFrom(METAS_PROYECTO)
