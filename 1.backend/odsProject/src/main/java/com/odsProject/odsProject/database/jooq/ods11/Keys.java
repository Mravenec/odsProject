...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds11Record> KEY_AUDITORIA_ODS11_PRIMARY = Internal.createUniqueKey(AuditoriaOds11.AUDITORIA_ODS11, DSL.name("KEY_auditoria_ods11_PRIMARY"), new TableField[] { AuditoriaOds11.AUDITORIA_ODS11.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds11Record, UsuariosRecord> AUDITORIA_ODS11_IBFK_1 = Internal.createForeignKey(AuditoriaOds11.AUDITORIA_ODS11, DSL.name("auditoria_ods11_ibfk_1"), new TableField[] { AuditoriaOds11.AUDITORIA_ODS11.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
