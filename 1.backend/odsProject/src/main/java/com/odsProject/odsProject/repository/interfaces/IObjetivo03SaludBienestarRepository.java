...
public interface IObjetivo03SaludBienestarRepository extends IOdsBaseRepository<Indicadores, Proyectos, MetasProyecto, MedicionesHistoricas, AuditoriaOds03> {
    ...
    /**
     * Encuentra todos los proyectos del ODS03
     * 
    ...
    /**
     * Encuentra un proyecto del ODS03 por su ID
     * 
     * @param proyectoId ID del proyecto
    ...
    /**
     * Encuentra todas las metas de proyecto del ODS03
     * 
     * @param proyectoId ID del proyecto
    ...
    /**
     * Encuentra una medición histórica del ODS03 por su ID
     * 
    ...
    /**
     * Encuentra todas las auditorías del ODS03
     * 
    ...
    /**
     * Encuentra una auditoría del ODS03 por su ID
     * 
