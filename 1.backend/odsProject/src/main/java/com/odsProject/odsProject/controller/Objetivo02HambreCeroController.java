...
public class Objetivo02HambreCeroController implements IObjetivo02HambreCeroController {
    ...
    public ResponseEntity<List<ProyectoIndicadores>> getAllIndicators(@RequestParam Integer proyectoId) {
        List<ProyectoIndicadores> result = objetivo02HambreCeroService.getAllIndicators(proyectoId);
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_1_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_1_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_1_2(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_1_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_2_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_2_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_2_2(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_2_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_2_3(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_2_3(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_2_4(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_2_4(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_3_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_3_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_3_2(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_3_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_4_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_4_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_5_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_5_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_5_2(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_5_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_a_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_a_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_a_2(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_a_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_b_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_b_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<ProyectoIndicadores>> getIndicador_2_c_1(@RequestParam Integer proyectoId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.getIndicador_2_c_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<ProyectoIndicadores>> findAllIndicadoresByProyectoOds02(@RequestParam Integer proyectoId) {
        List<ProyectoIndicadores> result = objetivo02HambreCeroService.findAllIndicadoresByProyecto(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<ProyectoIndicadorParametros>> getAllMetasProyectoOds02(@PathVariable Integer proyectoId) {
        List<ProyectoIndicadorParametros> result = objetivo02HambreCeroService.getAllMetasProyectoOds02(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<ProyectoIndicadores> getIndicador(@PathVariable Integer indicadorId) {
        Optional<ProyectoIndicadores> result = objetivo02HambreCeroService.findIndicadorById(indicadorId);
        return result.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(@RequestBody ProyectoIndicadores indicador) {
        ProyectoIndicadores result = objetivo02HambreCeroService.saveIndicador(indicador);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<ProyectoIndicadores> updateIndicador(@PathVariable Integer indicadorId, @RequestBody ProyectoIndicadores indicador) {
        ProyectoIndicadores result = objetivo02HambreCeroService.updateIndicador(indicador);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<ProyectoIndicadorParametros>> getMetasProyecto(@RequestParam Integer proyectoId) {
        List<ProyectoIndicadorParametros> result = objetivo02HambreCeroService.findAllMetasProyecto(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<ProyectoIndicadorParametros> getMetaProyecto(@PathVariable Integer metaId) {
        Optional<ProyectoIndicadorParametros> result = objetivo02HambreCeroService.findMetaProyectoById(metaId);
        return result.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(@RequestBody ProyectoIndicadorParametros meta) {
        ProyectoIndicadorParametros result = objetivo02HambreCeroService.saveMetaProyecto(meta);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<ProyectoIndicadorParametros> updateMetaProyecto(@PathVariable Integer metaId, @RequestBody ProyectoIndicadorParametros meta) {
        ProyectoIndicadorParametros result = objetivo02HambreCeroService.updateMetaProyecto(meta);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<ProyectoIndicadores>> findIndicadoresByMeta(@RequestParam Integer proyectoId, @RequestParam String metaPrefix) {
        List<ProyectoIndicadores> result = objetivo02HambreCeroService.findIndicadoresByMeta(proyectoId, metaPrefix);
        return ResponseEntity.ok(result);
    }
}
