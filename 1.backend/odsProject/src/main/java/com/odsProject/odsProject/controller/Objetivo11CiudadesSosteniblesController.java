...
public class Objetivo11CiudadesSosteniblesController implements IObjetivo11CiudadesSosteniblesController {
    ...
    private static final Logger log = LoggerFactory.getLogger(Objetivo11CiudadesSosteniblesController.class);
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(ProyectoIndicadores indicador) {
        try {
            return ResponseEntity.ok(objetivo11CiudadesSosteniblesService.saveIndicador(indicador));
        } catch (Exception e) {
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(ProyectoIndicadorParametros meta) {
        try {
            return ResponseEntity.ok(objetivo11CiudadesSosteniblesService.saveMetaProyecto(meta));
        } catch (Exception e) {
    ...
    @Override public ResponseEntity<java.util.Map<String, Object>> getDashboard() { return ResponseEntity.ok(objetivo11CiudadesSosteniblesService.getDashboardData()); }
    ...
    public ResponseEntity<java.util.Map<String, Object>> createMedicionAuditada(java.util.Map<String, Object> payload) {
        try {
            return ResponseEntity.ok(objetivo11CiudadesSosteniblesService.saveMedicionAuditada(payload));
    ...
    public ResponseEntity<java.util.Map<String, Object>> getMedicionAuditoria(Integer medicionId) {
        try {
            return ResponseEntity.ok(objetivo11CiudadesSosteniblesService.getMedicionAuditoria(medicionId));
        } catch (IllegalArgumentException e) {
