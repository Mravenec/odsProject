...
public class Objetivo04EducacionController implements IObjetivo04EducacionController {
    ...
    private static final Logger log = LoggerFactory.getLogger(Objetivo04EducacionController.class);
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(ProyectoIndicadores indicador) {
        try {
            return ResponseEntity.ok(objetivo04EducacionService.saveIndicador(indicador));
        } catch (Exception e) {
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(ProyectoIndicadorParametros meta) {
        try {
            return ResponseEntity.ok(objetivo04EducacionService.saveMetaProyecto(meta));
        } catch (Exception e) {
    ...
    public ResponseEntity<java.util.Map<String, Object>> createMedicionAuditada(java.util.Map<String, Object> payload) {
        try {
            return ResponseEntity.ok(objetivo04EducacionService.saveMedicionAuditada(payload));
    ...
    public ResponseEntity<java.util.Map<String, Object>> getMedicionAuditoria(Integer medicionId) {
        try {
            return ResponseEntity.ok(objetivo04EducacionService.getMedicionAuditoria(medicionId));
        } catch (IllegalArgumentException e) {
