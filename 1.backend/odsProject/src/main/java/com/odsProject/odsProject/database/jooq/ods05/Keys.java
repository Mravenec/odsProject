...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds05Record> KEY_AUDITORIA_ODS05_PRIMARY = Internal.createUniqueKey(AuditoriaOds05.AUDITORIA_ODS05, DSL.name("KEY_auditoria_ods05_PRIMARY"), new TableField[] { AuditoriaOds05.AUDITORIA_ODS05.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds05Record, UsuariosRecord> AUDITORIA_ODS05_IBFK_1 = Internal.createForeignKey(AuditoriaOds05.AUDITORIA_ODS05, DSL.name("auditoria_ods05_ibfk_1"), new TableField[] { AuditoriaOds05.AUDITORIA_ODS05.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
