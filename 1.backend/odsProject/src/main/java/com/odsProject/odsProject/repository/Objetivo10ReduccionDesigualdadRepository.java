...
import static com.odsProject.odsProject.database.jooq.ods10.tables.ProyectoIndicadores.PROYECTO_INDICADORES;
import static com.odsProject.odsProject.database.jooq.ods_master.tables.Proyectos.PROYECTOS;
import static com.odsProject.odsProject.database.jooq.ods10.tables.ProyectoIndicadorParametros.PROYECTO_INDICADOR_PARAMETROS;
...
public class Objetivo10ReduccionDesigualdadRepository implements IObjetivo10ReduccionDesigualdadRepository {
    ...
    private VistaAdminDetalleIndicadores mapToEnriched(Integer proyectoId, String codigo) {
        ...
        .where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(10)))
        .and(INDICADOR_MASTER.CODIGO.eq(codigo))
        .fetchOneInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_4_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.4.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_7_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.7.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_7_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.7.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_7_3(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.7.3"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_7_4(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.7.4"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_10_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "10.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds10(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds10(proyectoId); }
    ...
    @Override public List<AuditoriaOds10> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS10).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS10.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds10.class); }
    @Override public List<AuditoriaOds10> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS10).where(AUDITORIA_ODS10.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS10.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds10.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS10", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds10() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds10ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds10(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds10ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds10(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds10ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds10> findAllAuditoriasOds10() { return dsl.selectFrom(AUDITORIA_ODS10).fetchInto(AuditoriaOds10.class); }
    @Override public Optional<AuditoriaOds10> findAuditoriaOds10ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS10).where(AUDITORIA_ODS10.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds10.class); }
