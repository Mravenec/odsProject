...
import com.odsProject.odsProject.database.jooq.ods09.routines.SpAdminReporteProyecto;
import com.odsProject.odsProject.database.jooq.ods09.tables.pojos.VistaAdminResumenGeneral;
import com.odsProject.odsProject.repository.interfaces.IObjetivo09InfraestructuraRepository;
...
import static com.odsProject.odsProject.database.jooq.ods09.tables.VistaAdminResumenGeneral.VISTA_ADMIN_RESUMEN_GENERAL;
import static com.odsProject.odsProject.database.jooq.ods_login.tables.IndicadorMaster.INDICADOR_MASTER;
import static com.odsProject.odsProject.database.jooq.ods09.tables.MedicionParametroValores.MEDICION_PARAMETRO_VALORES;

/**
 * Implementación del Repositorio para el Objetivo 9: Industria, Innovación e Infraestructura
 */
@Slf4j
@Repository
public class Objetivo09InfraestructuraRepository implements IObjetivo09InfraestructuraRepository {
    ...
    private VistaAdminDetalleIndicadores mapToEnriched(Integer proyectoId, String codigo) {
        ...
        .where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(9)))
        .and(INDICADOR_MASTER.CODIGO.eq(codigo))
        .fetchOneInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_1_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.1.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_2_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.2.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_3_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.3.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_5_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.5.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_9_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "9.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds09(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds09(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(9))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds09> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS09).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS09.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds09.class); }
    @Override public List<AuditoriaOds09> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS09).where(AUDITORIA_ODS09.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS09.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds09.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS09", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds09() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds09ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds09(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds09ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds09(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds09ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds09> findAllAuditoriasOds09() { return dsl.selectFrom(AUDITORIA_ODS09).fetchInto(AuditoriaOds09.class); }
    @Override public Optional<AuditoriaOds09> findAuditoriaOds09ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS09).where(AUDITORIA_ODS09.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds09.class); }
