 ...
 */
public interface IObjetivo07EnergiaRepository extends IOdsBaseRepository<ProyectoIndicadores, Proyectos, ProyectoIndicadorParametros, MedicionesHistoricas, AuditoriaOds07> {
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_1_1(Integer proyectoId);
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_1_2(Integer proyectoId);
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_2_1(Integer proyectoId);
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_3_1(Integer proyectoId);
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_a_1(Integer proyectoId);
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_b_1(Integer proyectoId);
     ...
     */
    Optional<ProyectoIndicadores> findIndicador_7_c_1(Integer proyectoId);
