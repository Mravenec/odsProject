...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds12Record> KEY_AUDITORIA_ODS12_PRIMARY = Internal.createUniqueKey(AuditoriaOds12.AUDITORIA_ODS12, DSL.name("KEY_auditoria_ods12_PRIMARY"), new TableField[] { AuditoriaOds12.AUDITORIA_ODS12.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds12Record, UsuariosRecord> AUDITORIA_ODS12_IBFK_1 = Internal.createForeignKey(AuditoriaOds12.AUDITORIA_ODS12, DSL.name("auditoria_ods12_ibfk_1"), new TableField[] { AuditoriaOds12.AUDITORIA_ODS12.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
