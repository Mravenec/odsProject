...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds14Record> KEY_AUDITORIA_ODS14_PRIMARY = Internal.createUniqueKey(AuditoriaOds14.AUDITORIA_ODS14, DSL.name("KEY_auditoria_ods14_PRIMARY"), new TableField[] { AuditoriaOds14.AUDITORIA_ODS14.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds14Record, UsuariosRecord> AUDITORIA_ODS14_IBFK_1 = Internal.createForeignKey(AuditoriaOds14.AUDITORIA_ODS14, DSL.name("auditoria_ods14_ibfk_1"), new TableField[] { AuditoriaOds14.AUDITORIA_ODS14.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
