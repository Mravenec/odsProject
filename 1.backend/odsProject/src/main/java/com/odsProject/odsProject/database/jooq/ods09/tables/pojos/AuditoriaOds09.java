...
public class AuditoriaOds09 implements Serializable {
    ...
    public AuditoriaOds09(AuditoriaOds09 value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final AuditoriaOds09 other = (AuditoriaOds09) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("AuditoriaOds09 (");
