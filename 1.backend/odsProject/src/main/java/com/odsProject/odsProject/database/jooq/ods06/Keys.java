 ...
 */
package odsProject.database.jooq.ods06;


import odsProject.database.jooq.ods06.tables.AuditoriaOds06;
import odsProject.database.jooq.ods06.tables.Indicadores;
import odsProject.database.jooq.ods06.tables.MedicionesHistoricas;
import odsProject.database.jooq.ods06.tables.MetasProyecto;
...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds06Record, UsuariosRecord> AUDITORIA_ODS06_IBFK_1 = Internal.createForeignKey(AuditoriaOds06.AUDITORIA_ODS06, DSL.name("auditoria_ods06_ibfk_1"), new TableField[] { AuditoriaOds06.AUDITORIA_ODS06.USUARIO_ID }, odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
