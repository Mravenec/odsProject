...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds06Record> KEY_AUDITORIA_ODS06_PRIMARY = Internal.createUniqueKey(AuditoriaOds06.AUDITORIA_ODS06, DSL.name("KEY_auditoria_ods06_PRIMARY"), new TableField[] { AuditoriaOds06.AUDITORIA_ODS06.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds06Record, UsuariosRecord> AUDITORIA_ODS06_IBFK_1 = Internal.createForeignKey(AuditoriaOds06.AUDITORIA_ODS06, DSL.name("auditoria_ods06_ibfk_1"), new TableField[] { AuditoriaOds06.AUDITORIA_ODS06.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
