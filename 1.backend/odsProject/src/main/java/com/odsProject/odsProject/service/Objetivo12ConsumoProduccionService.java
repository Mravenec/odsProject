...
public class Objetivo12ConsumoProduccionService implements IObjetivo12ConsumoProduccionService {
    ...
    @Override public ProyectoIndicadorParametros saveMetaProyecto(ProyectoIndicadorParametros meta) { return objetivo12ConsumoProduccionRepository.saveMetaProyecto(meta); }
    @Override public ProyectoIndicadorParametros updateMetaProyecto(ProyectoIndicadorParametros meta) { return objetivo12ConsumoProduccionRepository.updateMetaProyecto(meta); }
