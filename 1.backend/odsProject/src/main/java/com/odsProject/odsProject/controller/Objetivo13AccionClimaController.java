...
public class Objetivo13AccionClimaController implements IObjetivo13AccionClimaController {
    ...
    public ResponseEntity<java.util.Map<String, Object>> createMedicionAuditada(java.util.Map<String, Object> payload) {
        try {
            return ResponseEntity.ok(objetivo13AccionClimaService.saveMedicionAuditada(payload));
    ...
    public ResponseEntity<java.util.Map<String, Object>> getMedicionAuditoria(Integer medicionId) {
        try {
            return ResponseEntity.ok(objetivo13AccionClimaService.getMedicionAuditoria(medicionId));
        } catch (IllegalArgumentException e) {
