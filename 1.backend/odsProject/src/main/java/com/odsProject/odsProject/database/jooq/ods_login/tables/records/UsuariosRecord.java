...
public class UsuariosRecord extends UpdatableRecordImpl<UsuariosRecord> {
     ...
     */
    public UsuariosRecord setUnidadProgramaticaId(Integer value) {
        set(10, value);
        return this;
    }
    ...
    public UsuariosRecord(Integer id, String username, String email, String passwordHash, String fullName, Integer rolId, Integer sedeId, UShort areaId, UShort dependenciaId, UByte rolDependenciaId, Integer unidadProgramaticaId, String telefonoContacto, Byte isActive, Byte emailVerificado, LocalDateTime ultimoLogin, UByte intentosFallidos, LocalDateTime bloqueadoHasta, String tokenRecuperacion, LocalDateTime tokenExpira, LocalDateTime createdAt, LocalDateTime updatedAt) {
        ...
        setUnidadProgramaticaId(unidadProgramaticaId);
    ...
    public UsuariosRecord(com.odsProject.odsProject.database.jooq.ods_login.tables.pojos.Usuarios value) {
        ...
        if (value != null) {
            ...
            setUnidadProgramaticaId(value.getUnidadProgramaticaId());
