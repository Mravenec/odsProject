...
import com.odsProject.odsProject.database.jooq.ods17.routines.SpAdminDashboard;
...
import static com.odsProject.odsProject.database.jooq.ods17.tables.Indicadores.INDICADORES;
import static com.odsProject.odsProject.database.jooq.ods17.tables.Proyectos.PROYECTOS;
import static com.odsProject.odsProject.database.jooq.ods17.tables.MetasProyecto.METAS_PROYECTO;
...
public class Objetivo17AlianzasRepository implements IObjetivo17AlianzasRepository {
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_1_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.1.1"))
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_1_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.1.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_2_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.2.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_3_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.3.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_3_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.3.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_4_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.4.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_5_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.5.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_6_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.6.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_7_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.7.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_8_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.8.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_9_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.9.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_10_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.10.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_11_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.11.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_12_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.12.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_13_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.13.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_14_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.14.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_15_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.15.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_16_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.16.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_17_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.17.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_18_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.18.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_18_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.18.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_18_3(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.18.3"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_19_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.19.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_17_19_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("17.19.2"))
                .fetchOptionalInto(Indicadores.class);
    }
    ...
    public List<Indicadores> findAllIndicadoresByProyectoOds17(Integer proyectoId) {
        ...
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.like("17.%"))
    ...
    public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of(
            "status", "executed",
            "message", "Dashboard procedure executed for ODS17"
        );
    }
     ...
     */
    @Override
    public List<MetasProyecto> findAllMetasProyectoOds17(Integer proyectoId) {
        return dsl.selectFrom(METAS_PROYECTO)
                .where(METAS_PROYECTO.PROYECTO_ID.eq(proyectoId))
                .fetchInto(MetasProyecto.class);
    }
     ...
     */
    @Override
    public Optional<MetasProyecto> findMetaProyectoOds17ById(Integer metaId) {
        return dsl.selectFrom(METAS_PROYECTO)
