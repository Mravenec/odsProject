...
public class Objetivo16PazJusticiaController implements IObjetivo16PazJusticiaController {
    ...
    private static final Logger log = LoggerFactory.getLogger(Objetivo16PazJusticiaController.class);
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(ProyectoIndicadores indicador) {
        try {
            return ResponseEntity.ok(objetivo16PazJusticiaService.saveIndicador(indicador));
        } catch (Exception e) {
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(ProyectoIndicadorParametros meta) {
        try {
            return ResponseEntity.ok(objetivo16PazJusticiaService.saveMetaProyecto(meta));
        } catch (Exception e) {
    ...
    public ResponseEntity<java.util.Map<String, Object>> createMedicionAuditada(java.util.Map<String, Object> payload) {
        try {
            return ResponseEntity.ok(objetivo16PazJusticiaService.saveMedicionAuditada(payload));
    ...
    public ResponseEntity<java.util.Map<String, Object>> getMedicionAuditoria(Integer medicionId) {
        try {
            return ResponseEntity.ok(objetivo16PazJusticiaService.getMedicionAuditoria(medicionId));
        } catch (IllegalArgumentException e) {
