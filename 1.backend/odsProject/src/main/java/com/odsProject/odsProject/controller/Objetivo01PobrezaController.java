...
public class Objetivo01PobrezaController implements IObjetivo01PobrezaController {
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(ProyectoIndicadores indicador) {
        try {
            return ResponseEntity.ok(objetivo01PobrezaService.saveIndicador(indicador));
        } catch (Exception e) {
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(ProyectoIndicadorParametros meta) {
        try {
            return ResponseEntity.ok(objetivo01PobrezaService.saveMetaProyecto(meta));
        } catch (Exception e) {
    ...
    public ResponseEntity<java.util.Map<String, Object>> createMedicionAuditada(java.util.Map<String, Object> payload) {
        try {
            return ResponseEntity.ok(objetivo01PobrezaService.saveMedicionAuditada(payload));
    ...
    public ResponseEntity<java.util.Map<String, Object>> getMedicionAuditoria(Integer medicionId) {
        try {
            return ResponseEntity.ok(objetivo01PobrezaService.getMedicionAuditoria(medicionId));
        } catch (IllegalArgumentException e) {
