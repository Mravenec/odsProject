 ...
 */
package com.odsProject.odsProject.database.jooq.ods17;


import com.odsProject.odsProject.database.jooq.ods17.tables.AuditoriaOds17;
import com.odsProject.odsProject.database.jooq.ods17.tables.MedicionParametroValores;
...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds17Record> KEY_AUDITORIA_ODS17_PRIMARY = Internal.createUniqueKey(AuditoriaOds17.AUDITORIA_ODS17, DSL.name("KEY_auditoria_ods17_PRIMARY"), new TableField[] { AuditoriaOds17.AUDITORIA_ODS17.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds17Record, UsuariosRecord> AUDITORIA_ODS17_IBFK_1 = Internal.createForeignKey(AuditoriaOds17.AUDITORIA_ODS17, DSL.name("auditoria_ods17_ibfk_1"), new TableField[] { AuditoriaOds17.AUDITORIA_ODS17.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
