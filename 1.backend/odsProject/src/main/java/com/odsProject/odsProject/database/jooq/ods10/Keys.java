...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds10Record> KEY_AUDITORIA_ODS10_PRIMARY = Internal.createUniqueKey(AuditoriaOds10.AUDITORIA_ODS10, DSL.name("KEY_auditoria_ods10_PRIMARY"), new TableField[] { AuditoriaOds10.AUDITORIA_ODS10.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds10Record, UsuariosRecord> AUDITORIA_ODS10_IBFK_1 = Internal.createForeignKey(AuditoriaOds10.AUDITORIA_ODS10, DSL.name("auditoria_ods10_ibfk_1"), new TableField[] { AuditoriaOds10.AUDITORIA_ODS10.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
