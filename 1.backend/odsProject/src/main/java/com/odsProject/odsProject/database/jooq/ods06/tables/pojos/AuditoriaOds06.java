...
public class AuditoriaOds06 implements Serializable {
    ...
    public AuditoriaOds06(AuditoriaOds06 value) {
        this.id = value.id;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final AuditoriaOds06 other = (AuditoriaOds06) obj;
        if (this.id == null) {
            if (other.id != null)
                return false;
        }
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("AuditoriaOds06 (");
