...
public class Keys {
    ...
    public static final UniqueKey<AuditoriaOds01Record> KEY_AUDITORIA_ODS01_PRIMARY = Internal.createUniqueKey(AuditoriaOds01.AUDITORIA_ODS01, DSL.name("KEY_auditoria_ods01_PRIMARY"), new TableField[] { AuditoriaOds01.AUDITORIA_ODS01.ID }, true);
    ...
    public static final ForeignKey<AuditoriaOds01Record, UsuariosRecord> AUDITORIA_ODS01_IBFK_1 = Internal.createForeignKey(AuditoriaOds01.AUDITORIA_ODS01, DSL.name("auditoria_ods01_ibfk_1"), new TableField[] { AuditoriaOds01.AUDITORIA_ODS01.USUARIO_ID }, com.odsProject.odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
