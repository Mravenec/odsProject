 ...
 */
package odsProject.database.jooq.ods15;


import odsProject.database.jooq.ods15.tables.AuditoriaOds15;
import odsProject.database.jooq.ods15.tables.Indicadores;
import odsProject.database.jooq.ods15.tables.MedicionesHistoricas;
import odsProject.database.jooq.ods15.tables.MetasProyecto;
...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds15Record, UsuariosRecord> AUDITORIA_ODS15_IBFK_1 = Internal.createForeignKey(AuditoriaOds15.AUDITORIA_ODS15, DSL.name("auditoria_ods15_ibfk_1"), new TableField[] { AuditoriaOds15.AUDITORIA_ODS15.USUARIO_ID }, odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
