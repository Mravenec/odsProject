...
import com.odsProject.odsProject.database.jooq.ods15.tables.pojos.VistaAdminResumenGeneral;
...
import static com.odsProject.odsProject.database.jooq.ods15.tables.VistaAdminResumenGeneral.VISTA_ADMIN_RESUMEN_GENERAL;
import static com.odsProject.odsProject.database.jooq.ods_login.tables.IndicadorMaster.INDICADOR_MASTER;
import static com.odsProject.odsProject.database.jooq.ods15.tables.MedicionParametroValores.MEDICION_PARAMETRO_VALORES;
...
public class Objetivo15VidaEcosistemasRepository implements IObjetivo15VidaEcosistemasRepository {
    ...
    private VistaAdminDetalleIndicadores mapToEnriched(Integer proyectoId, String codigo) {
        ...
        .where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(15)))
        .and(INDICADOR_MASTER.CODIGO.eq(codigo))
        .fetchOneInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_1_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.1.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_4_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.4.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_7_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.7.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_8_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.8.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_9_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.9.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_15_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "15.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds15(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds15(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(15))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds15> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS15).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS15.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds15.class); }
    @Override public List<AuditoriaOds15> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS15).where(AUDITORIA_ODS15.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS15.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds15.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS15", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds15() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds15ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds15(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds15ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds15(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds15ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds15> findAllAuditoriasOds15() { return dsl.selectFrom(AUDITORIA_ODS15).fetchInto(AuditoriaOds15.class); }
    @Override public Optional<AuditoriaOds15> findAuditoriaOds15ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS15).where(AUDITORIA_ODS15.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds15.class); }
