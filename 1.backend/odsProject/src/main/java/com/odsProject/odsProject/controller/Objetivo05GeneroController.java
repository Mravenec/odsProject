...
public class Objetivo05GeneroController implements IObjetivo05GeneroController {
    ...
    public ResponseEntity<List<Indicadores>> getAllIndicators(@RequestParam Integer proyectoId) {
        List<Indicadores> result = objetivo05GeneroService.getAllIndicators(proyectoId);
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_1_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_1_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_2_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_2_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_2_2(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_2_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_3_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_3_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_3_2(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_3_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_4_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_4_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_5_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_5_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_5_2(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_5_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_6_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_6_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_6_2(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_6_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_a_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_a_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_a_2(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_a_2(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_b_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_b_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Optional<Indicadores>> getIndicador_5_c_1(@RequestParam Integer proyectoId) {
        Optional<Indicadores> result = objetivo05GeneroService.getIndicador_5_c_1(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<Indicadores>> findAllIndicadoresByProyectoOds05(@RequestParam Integer proyectoId) {
        List<Indicadores> result = objetivo05GeneroService.findAllIndicadoresByProyectoOds05(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<List<Indicadores>> findIndicadoresByMeta(@RequestParam Integer proyectoId, @RequestParam String metaPrefix) {
        List<Indicadores> result = objetivo05GeneroService.findIndicadoresByMeta(proyectoId, metaPrefix);
        return ResponseEntity.ok(result);
    }
    ...
    /**
     * Obtiene una meta de proyecto del ODS05 por su ID
     * 
    ...
    /**
     * Obtiene una medición histórica del ODS05 por su ID
     * 
    ...
    public ResponseEntity<List<Indicadores>> getIndicadores(@RequestParam Integer proyectoId) {
        List<Indicadores> result = objetivo05GeneroService.findAllIndicadoresByProyecto(proyectoId);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Indicadores> getIndicador(@PathVariable Integer indicadorId) {
        Optional<Indicadores> result = objetivo05GeneroService.findIndicadorById(indicadorId);
        return result.map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
    ...
    public ResponseEntity<Indicadores> createIndicador(@RequestBody Indicadores indicador) {
        Indicadores result = objetivo05GeneroService.saveIndicador(indicador);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<Indicadores> updateIndicador(@PathVariable Integer indicadorId, @RequestBody Indicadores indicador) {
        Indicadores result = objetivo05GeneroService.updateIndicador(indicador);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<MetasProyecto> createMetaProyecto(@RequestBody MetasProyecto meta) {
        MetasProyecto result = objetivo05GeneroService.saveMetaProyecto(meta);
        return ResponseEntity.ok(result);
    }
    ...
    public ResponseEntity<MetasProyecto> updateMetaProyecto(@PathVariable Integer metaId, @RequestBody MetasProyecto meta) {
        MetasProyecto result = objetivo05GeneroService.updateMetaProyecto(meta);
        return ResponseEntity.ok(result);
    }
