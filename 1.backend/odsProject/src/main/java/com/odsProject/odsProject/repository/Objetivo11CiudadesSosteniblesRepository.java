...
import com.odsProject.odsProject.database.jooq.ods11.tables.pojos.VistaAdminResumenGeneral;
...
import static com.odsProject.odsProject.database.jooq.ods11.tables.VistaAdminResumenGeneral.VISTA_ADMIN_RESUMEN_GENERAL;
import static com.odsProject.odsProject.database.jooq.ods_login.tables.IndicadorMaster.INDICADOR_MASTER;
import static com.odsProject.odsProject.database.jooq.ods11.tables.MedicionParametroValores.MEDICION_PARAMETRO_VALORES;
...
public class Objetivo11CiudadesSosteniblesRepository implements IObjetivo11CiudadesSosteniblesRepository {
    ...
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_3_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.3.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_5_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.5.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_5_3(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.5.3"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_6_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.6.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_7_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.7.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_7_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.7.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_b_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.b.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_11_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "11.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds11(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds11(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(11))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds11> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS11).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS11.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds11.class); }
    @Override public List<AuditoriaOds11> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS11).where(AUDITORIA_ODS11.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS11.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds11.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS11", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds11() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds11ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds11(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds11ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds11(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds11ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds11> findAllAuditoriasOds11() { return dsl.selectFrom(AUDITORIA_ODS11).fetchInto(AuditoriaOds11.class); }
    @Override public Optional<AuditoriaOds11> findAuditoriaOds11ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS11).where(AUDITORIA_ODS11.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds11.class); }
