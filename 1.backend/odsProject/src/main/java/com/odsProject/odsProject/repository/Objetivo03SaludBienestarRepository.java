...
import com.odsProject.odsProject.database.jooq.ods03.tables.pojos.VistaAdminResumenGeneral;
...
import static com.odsProject.odsProject.database.jooq.ods03.tables.ProyectoIndicadores.PROYECTO_INDICADORES;
import static com.odsProject.odsProject.database.jooq.ods_master.tables.Proyectos.PROYECTOS;
import static com.odsProject.odsProject.database.jooq.ods03.tables.ProyectoIndicadorParametros.PROYECTO_INDICADOR_PARAMETROS;
...
import static com.odsProject.odsProject.database.jooq.ods03.tables.VistaAdminResumenGeneral.VISTA_ADMIN_RESUMEN_GENERAL;
...
public class Objetivo03SaludBienestarRepository implements IObjetivo03SaludBienestarRepository {
    ...
    private VistaAdminDetalleIndicadores mapToEnriched(Integer proyectoId, String codigo) {
        ...
        .where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(3)))
        .and(INDICADOR_MASTER.CODIGO.eq(codigo))
        .fetchOneInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_1_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.1.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_2_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.2.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_3_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.3.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_3_3(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.3.3"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_3_4(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.3.4"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_3_5(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.3.5"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_4_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.4.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_5_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.5.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_6_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.6.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_7_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.7.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_7_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.7.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_8_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.8.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_8_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.8.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_9_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.9.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_9_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.9.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_9_3(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.9.3"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_b_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.b.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_b_3(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.b.3"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.c.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_d_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.d.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_3_d_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "3.d.2"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds03(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds03(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(3))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public ProyectoIndicadores saveIndicador(ProyectoIndicadores indicador) {
        return dsl.insertInto(PROYECTO_INDICADORES).set(dsl.newRecord(PROYECTO_INDICADORES, indicador)).returning().fetchOneInto(ProyectoIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds03> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS03).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS03.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds03.class); }
    @Override public List<AuditoriaOds03> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS03).where(AUDITORIA_ODS03.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS03.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds03.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS03", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds03() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds03ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds03(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds03ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds03(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds03ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds03> findAllAuditoriasOds03() { return dsl.selectFrom(AUDITORIA_ODS03).fetchInto(AuditoriaOds03.class); }
    @Override public Optional<AuditoriaOds03> findAuditoriaOds03ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS03).where(AUDITORIA_ODS03.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds03.class); }
