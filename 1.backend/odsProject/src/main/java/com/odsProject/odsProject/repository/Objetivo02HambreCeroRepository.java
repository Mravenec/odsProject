...
public class Objetivo02HambreCeroRepository implements IObjetivo02HambreCeroRepository {
    ...
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_1_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.1.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_2_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.2.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_2_3(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.2.3"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_2_4(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.2.4"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_3_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.3.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_5_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.5.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_a_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.a.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_2_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "2.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds02(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds02(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(2))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds02> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS02).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS02.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds02.class); }
    @Override public List<AuditoriaOds02> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS02).where(AUDITORIA_ODS02.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS02.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds02.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS02", "data", resumen);
    }
    @Override public Map<String, Object> spAdminReporteProyecto(Integer proyectoId) {
        ...
        return Map.of("status", "executed", "proyectoId", proyectoId, "message", "Reporte procedure executed for ODS02");
    }

    @Override public List<Proyectos> findAllProyectosOds02() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds02ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds02(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds02ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds02(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds02ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds02> findAllAuditoriasOds02() { return dsl.selectFrom(AUDITORIA_ODS02).fetchInto(AuditoriaOds02.class); }
    @Override public Optional<AuditoriaOds02> findAuditoriaOds02ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS02).where(AUDITORIA_ODS02.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds02.class); }
