...
import com.odsProject.odsProject.database.jooq.ods13.routines.SpAdminDashboard;
...
import static com.odsProject.odsProject.database.jooq.ods13.tables.Indicadores.INDICADORES;
import static com.odsProject.odsProject.database.jooq.ods13.tables.Proyectos.PROYECTOS;
import static com.odsProject.odsProject.database.jooq.ods13.tables.MetasProyecto.METAS_PROYECTO;
 ...
 * Implementa los métodos para acceder a los indicadores del ODS13 usando jOOQ
 * Usa datasource ods13 y sus propios stored procedures
 */
@Repository
public class Objetivo13AccionClimaticaRepository implements IObjetivo13AccionClimaRepository {
    ...
    // ── Métodos específicos de indicadores del ODS13 ──

    /**
     * {@inheritDoc}
     */
    @Override
    public Optional<Indicadores> findIndicador_13_1_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.1.1"))
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_1_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.1.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_1_3(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.1.3"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_2_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.2.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_2_2(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.2.2"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_3_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.3.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_a_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.a.1"))
                .fetchOptionalInto(Indicadores.class);
    }
     ...
     */
    @Override
    public Optional<Indicadores> findIndicador_13_b_1(Integer proyectoId) {
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.eq("13.b.1"))
                .fetchOptionalInto(Indicadores.class);
    }
    ...
    public List<Indicadores> findAllIndicadoresByProyectoOds13(Integer proyectoId) {
        // Usar el stored procedure sp_admin_reporte_proyecto del ODS13
        ...
        return dsl.selectFrom(INDICADORES)
                .where(INDICADORES.PROYECTO_ID.eq(proyectoId))
                .and(INDICADORES.INDICADOR_CODIGO.like("13.%"))
     ...
     */
    @Override
    public List<AuditoriaOds13> findAuditoriaReciente(Integer dias) {
        return dsl.selectFrom(AUDITORIA_ODS13)
                .where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS13.FECHA_CAMBIO, dias)
                .fetchInto(AuditoriaOds13.class);
    }
     ...
     */
    @Override
    public List<AuditoriaOds13> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) {
        return dsl.selectFrom(AUDITORIA_ODS13)
                .where(AUDITORIA_ODS13.TABLA_AFECTADA.eq(tablaAfectada))
                .and(AUDITORIA_ODS13.REGISTRO_ID.eq(registroId))
                .fetchInto(AuditoriaOds13.class);
    }
    ...
    public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of(
            "status", "executed",
            "message", "Dashboard procedure executed for ODS13"
        );
    }
    ...
    public Map<String, Object> spAdminReporteProyecto(Integer proyectoId) {
        ...
        return Map.of(
            ...
            "message", "Reporte procedure executed for ODS13"
        );
    }
     ...
     */
    @Override
    public List<Proyectos> findAllProyectosOds13() {
        return dsl.selectFrom(PROYECTOS)
                .fetchInto(Proyectos.class);
    }
     ...
     */
    @Override
    public Optional<Proyectos> findProyectoOds13ById(Integer proyectoId) {
        return dsl.selectFrom(PROYECTOS)
     ...
     */
    @Override
    public List<MetasProyecto> findAllMetasProyectoOds13(Integer proyectoId) {
        return dsl.selectFrom(METAS_PROYECTO)
                .where(METAS_PROYECTO.PROYECTO_ID.eq(proyectoId))
                .fetchInto(MetasProyecto.class);
    }
     ...
     */
    @Override
    public Optional<MetasProyecto> findMetaProyectoOds13ById(Integer metaId) {
        return dsl.selectFrom(METAS_PROYECTO)
     ...
     */
    @Override
    public List<MedicionesHistoricas> findAllMedicionesHistoricasOds13(Integer indicadorId) {
        return dsl.selectFrom(MEDICIONES_HISTORICAS)
                .where(MEDICIONES_HISTORICAS.INDICADOR_ID.eq(indicadorId))
                .fetchInto(MedicionesHistoricas.class);
    }
     ...
     */
    @Override
    public Optional<MedicionesHistoricas> findMedicionHistoricaOds13ById(Integer medicionId) {
        return dsl.selectFrom(MEDICIONES_HISTORICAS)
     ...
     */
    @Override
    public List<AuditoriaOds13> findAllAuditoriasOds13() {
        return dsl.selectFrom(AUDITORIA_ODS13)
                .fetchInto(AuditoriaOds13.class);
    }
     ...
     */
    @Override
    public Optional<AuditoriaOds13> findAuditoriaOds13ById(Integer auditoriaId) {
        return dsl.selectFrom(AUDITORIA_ODS13)
                .where(AUDITORIA_ODS13.ID.eq(auditoriaId))
                .fetchOptionalInto(AuditoriaOds13.class);
    }
}
