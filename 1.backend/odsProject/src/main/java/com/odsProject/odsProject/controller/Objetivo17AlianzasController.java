...
public class Objetivo17AlianzasController implements IObjetivo17AlianzasController {
    ...
    public ResponseEntity<MetasProyecto> getMetaProyectoOds17ById(@PathVariable Integer metaId) {
    ...
    public ResponseEntity<MedicionesHistoricas> getMedicionHistoricaOds17ById(@PathVariable Integer medicionId) {
