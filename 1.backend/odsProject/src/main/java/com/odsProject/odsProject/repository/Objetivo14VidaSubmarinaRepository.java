...
import com.odsProject.odsProject.database.jooq.ods14.tables.pojos.VistaAdminResumenGeneral;
...
import static com.odsProject.odsProject.database.jooq.ods14.tables.VistaAdminResumenGeneral.VISTA_ADMIN_RESUMEN_GENERAL;
import static com.odsProject.odsProject.database.jooq.ods_login.tables.IndicadorMaster.INDICADOR_MASTER;
import static com.odsProject.odsProject.database.jooq.ods14.tables.MedicionParametroValores.MEDICION_PARAMETRO_VALORES;
...
public class Objetivo14VidaSubmarinaRepository implements IObjetivo14VidaSubmarinaRepository {
    ...
    private VistaAdminDetalleIndicadores mapToEnriched(Integer proyectoId, String codigo) {
        ...
        .where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(14)))
        .and(INDICADOR_MASTER.CODIGO.eq(codigo))
        .fetchOneInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_7_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.7.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_14_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "14.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds14(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds14(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(14))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds14> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS14).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS14.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds14.class); }
    @Override public List<AuditoriaOds14> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS14).where(AUDITORIA_ODS14.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS14.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds14.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS14", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds14() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds14ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds14(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds14ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds14(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds14ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds14> findAllAuditoriasOds14() { return dsl.selectFrom(AUDITORIA_ODS14).fetchInto(AuditoriaOds14.class); }
    @Override public Optional<AuditoriaOds14> findAuditoriaOds14ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS14).where(AUDITORIA_ODS14.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds14.class); }
