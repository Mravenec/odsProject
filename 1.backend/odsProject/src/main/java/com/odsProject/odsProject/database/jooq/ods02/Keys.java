...
import odsProject.database.jooq.ods_login.tables.Usuarios;
...
public class Keys {
    ...
    public static final ForeignKey<AuditoriaOds02Record, UsuariosRecord> AUDITORIA_ODS02_IBFK_1 = Internal.createForeignKey(AuditoriaOds02.AUDITORIA_ODS02, DSL.name("auditoria_ods02_ibfk_1"), new TableField[] { AuditoriaOds02.AUDITORIA_ODS02.USUARIO_ID }, odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
    ...
    public static final ForeignKey<ProyectosRecord, UsuariosRecord> PROYECTOS_IBFK_1 = Internal.createForeignKey(Proyectos.PROYECTOS, DSL.name("proyectos_ibfk_1"), new TableField[] { Proyectos.PROYECTOS.USUARIO_ID }, odsProject.database.jooq.ods_login.Keys.KEY_USUARIOS_PRIMARY, new TableField[] { Usuarios.USUARIOS.ID }, true);
}
