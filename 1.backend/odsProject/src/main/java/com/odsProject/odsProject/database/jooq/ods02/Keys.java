...
public class Keys {
    ...
    public static final UniqueKey<ProyectoIndicadoresRecord> KEY_PROYECTO_INDICADORES_UK_PROYECTO_INDICADOR = Internal.createUniqueKey(ProyectoIndicadores.PROYECTO_INDICADORES, DSL.name("KEY_proyecto_indicadores_uk_proyecto_indicador"), new TableField[] { ProyectoIndicadores.PROYECTO_INDICADORES.PROYECTO_ID, ProyectoIndicadores.PROYECTO_INDICADORES.INDICADOR_MASTER_ID }, true);
    ...
    public static final ForeignKey<ProyectoIndicadoresRecord, ProyectosRecord> PROYECTO_INDICADORES_IBFK_1 = Internal.createForeignKey(ProyectoIndicadores.PROYECTO_INDICADORES, DSL.name("proyecto_indicadores_ibfk_1"), new TableField[] { ProyectoIndicadores.PROYECTO_INDICADORES.PROYECTO_ID }, com.odsProject.odsProject.database.jooq.ods_master.Keys.KEY_PROYECTOS_PRIMARY, new TableField[] { Proyectos.PROYECTOS.ID }, true);
