...
public class Objetivo14VidaSubmarinaController implements IObjetivo14VidaSubmarinaController {
    ...
    private static final Logger log = LoggerFactory.getLogger(Objetivo14VidaSubmarinaController.class);
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(ProyectoIndicadores indicador) {
        try {
            return ResponseEntity.ok(objetivo14VidaSubmarinaService.saveIndicador(indicador));
        } catch (Exception e) {
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(ProyectoIndicadorParametros meta) {
        try {
            return ResponseEntity.ok(objetivo14VidaSubmarinaService.saveMetaProyecto(meta));
        } catch (Exception e) {
