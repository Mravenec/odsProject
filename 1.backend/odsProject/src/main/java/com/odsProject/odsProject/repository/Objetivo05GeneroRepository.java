...
import com.odsProject.odsProject.database.jooq.ods05.routines.SpAdminReporteProyecto;
import com.odsProject.odsProject.database.jooq.ods05.tables.pojos.VistaAdminResumenGeneral;
import com.odsProject.odsProject.repository.interfaces.IObjetivo05GeneroRepository;
...
import static com.odsProject.odsProject.database.jooq.ods05.tables.ProyectoIndicadores.PROYECTO_INDICADORES;
import static com.odsProject.odsProject.database.jooq.ods_master.tables.Proyectos.PROYECTOS;
import static com.odsProject.odsProject.database.jooq.ods05.tables.ProyectoIndicadorParametros.PROYECTO_INDICADOR_PARAMETROS;
import static com.odsProject.odsProject.database.jooq.ods05.tables.MedicionesHistoricas.MEDICIONES_HISTORICAS;
import static com.odsProject.odsProject.database.jooq.ods05.tables.AuditoriaOds05.AUDITORIA_ODS05;
import static com.odsProject.odsProject.database.jooq.ods05.tables.VistaAdminResumenGeneral.VISTA_ADMIN_RESUMEN_GENERAL;
import static com.odsProject.odsProject.database.jooq.ods_login.tables.IndicadorMaster.INDICADOR_MASTER;
import static com.odsProject.odsProject.database.jooq.ods05.tables.MedicionParametroValores.MEDICION_PARAMETRO_VALORES;

/**
 * Implementación del Repositorio para el Objetivo 5: Igualdad de Género
 */
@Slf4j
@Repository
public class Objetivo05GeneroRepository implements IObjetivo05GeneroRepository {
    ...
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_2_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.2.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_3_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.3.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_5_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.5.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_6_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.6.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_a_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.a.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_5_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "5.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds05(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds05(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(5))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<AuditoriaOds05> findAuditoriaReciente(Integer dias) { return dsl.selectFrom(AUDITORIA_ODS05).where("{0} >= DATE_SUB(NOW(), INTERVAL ? DAY)", AUDITORIA_ODS05.FECHA_CAMBIO, dias).fetchInto(AuditoriaOds05.class); }
    @Override public List<AuditoriaOds05> findAuditoriaByRegistro(String tablaAfectada, Integer registroId) { return dsl.selectFrom(AUDITORIA_ODS05).where(AUDITORIA_ODS05.TABLA_AFECTADA.eq(tablaAfectada)).and(AUDITORIA_ODS05.REGISTRO_ID.eq(registroId)).fetchInto(AuditoriaOds05.class); }
    ...
    @Override public Map<String, Object> spAdminDashboard() {
        ...
        return Map.of("status", "executed", "message", "Dashboard data retrieved from view for ODS05", "data", resumen);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds05() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds05ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds05(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds05ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMetasMedicionesHistoricasOds05(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds05ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds05> findAllAuditoriasOds05() { return dsl.selectFrom(AUDITORIA_ODS05).fetchInto(AuditoriaOds05.class); }
    @Override public Optional<AuditoriaOds05> findAuditoriaOds05ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS05).where(AUDITORIA_ODS05.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds05.class); }
    ...
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds05(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
