...
public class Objetivo15VidaEcosistemasController implements IObjetivo15VidaEcosistemasController {
    ...
    private static final Logger log = LoggerFactory.getLogger(Objetivo15VidaEcosistemasController.class);
    ...
    public ResponseEntity<ProyectoIndicadores> createIndicador(ProyectoIndicadores indicador) {
        try {
            return ResponseEntity.ok(objetivo15VidaEcosistemasService.saveIndicador(indicador));
        } catch (Exception e) {
    ...
    public ResponseEntity<ProyectoIndicadorParametros> createMetaProyecto(ProyectoIndicadorParametros meta) {
        try {
            return ResponseEntity.ok(objetivo15VidaEcosistemasService.saveMetaProyecto(meta));
        } catch (Exception e) {
    ...
    @Override public ResponseEntity<java.util.Map<String, Object>> getDashboard() { return ResponseEntity.ok(objetivo15VidaEcosistemasService.getDashboardData()); }
