...
> {
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_1_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_2_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_3_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_4_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_4_2(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_5_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_6_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_7_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_7_2(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_7_3(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_7_4(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_a_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_b_1(Integer proyectoId);
     ...
     */
    ResponseEntity<Optional<VistaAdminDetalleIndicadores>> getIndicador_10_c_1(Integer proyectoId);
     ...
     */
    ResponseEntity<List<VistaAdminDetalleIndicadores>> findAllIndicadoresByProyectoOds10(Integer proyectoId);
