...
import static com.odsProject.odsProject.database.jooq.ods04.tables.ProyectoIndicadores.PROYECTO_INDICADORES;
...
import static com.odsProject.odsProject.database.jooq.ods04.tables.MedicionParametroValores.MEDICION_PARAMETRO_VALORES;

/**
 * Implementación del Repositorio para el Objetivo 4: Educación de Calidad
 */
@Slf4j
@Repository
public class Objetivo04EducacionRepository implements IObjetivo04EducacionRepository {
    ...
    private VistaAdminDetalleIndicadores mapToEnriched(Integer proyectoId, String codigo) {
        ...
        .where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(4)))
        .and(INDICADOR_MASTER.CODIGO.eq(codigo))
        .fetchOneInto(VistaAdminDetalleIndicadores.class);
    }

    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_1_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.1.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_1_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.1.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_2_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.2.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_2_2(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.2.2"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_3_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.3.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_4_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.4.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_5_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.5.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_6_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.6.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_7_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.7.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_a_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.a.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_b_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.b.1"); }
    @Override public Optional<VistaAdminDetalleIndicadores> findIndicador_4_c_1(Integer proyectoId) { return findIndicadorByCodigo(proyectoId, "4.c.1"); }

    @Override public List<VistaAdminDetalleIndicadores> findAllIndicadoresByProyectoOds04(Integer proyectoId) {
        return dsl.select(
            PROYECTO_INDICADORES.PROYECTO_ID, 
            PROYECTOS.NOMBRE_PROYECTO, 
            INDICADOR_MASTER.ID.as("indicador_master_id"),
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByProyecto(Integer proyectoId) { return findAllIndicadoresByProyectoOds04(proyectoId); }
    ...
    @Override public List<VistaAdminDetalleIndicadores> findIndicadoresByCodigoPrefix(String prefix) {
        return dsl.select(INDICADOR_MASTER.CODIGO.as("indicador_codigo"), INDICADOR_MASTER.NOMBRE.as("indicador_nombre")).from(INDICADOR_MASTER).where(INDICADOR_MASTER.ODS_ID.eq(UByte.valueOf(4))).and(INDICADOR_MASTER.CODIGO.startsWith(prefix)).fetchInto(VistaAdminDetalleIndicadores.class);
    }
    ...
    @Override public List<Proyectos> findAllProyectosOds04() { return findAllProyectos(); }
    @Override public Optional<Proyectos> findProyectoOds04ById(Integer proyectoId) { return findProyectoById(proyectoId); }
    @Override public List<ProyectoIndicadorParametros> findAllMetasProyectoOds04(Integer proyectoId) { return findMetasByProyecto(proyectoId); }
    @Override public Optional<ProyectoIndicadorParametros> findMetaProyectoOds04ById(Integer metaId) { return dsl.selectFrom(PROYECTO_INDICADOR_PARAMETROS).where(PROYECTO_INDICADOR_PARAMETROS.ID.eq(metaId)).fetchOptionalInto(ProyectoIndicadorParametros.class); }
    @Override public List<MedicionesHistoricas> findAllMetasEducacionOds04(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
    @Override public Optional<MedicionesHistoricas> findMedicionHistoricaOds04ById(Integer medicionId) { return dsl.selectFrom(MEDICIONES_HISTORICAS).where(MEDICIONES_HISTORICAS.ID.eq(medicionId)).fetchOptionalInto(MedicionesHistoricas.class); }
    @Override public List<AuditoriaOds04> findAllAuditoriasOds04() { return dsl.selectFrom(AUDITORIA_ODS04).fetchInto(AuditoriaOds04.class); }
    @Override public Optional<AuditoriaOds04> findAuditoriaOds04ById(Integer auditoriaId) { return dsl.selectFrom(AUDITORIA_ODS04).where(AUDITORIA_ODS04.ID.eq(auditoriaId)).fetchOptionalInto(AuditoriaOds04.class); }
    ...
    @Override public List<MedicionesHistoricas> findAllMedicionesHistoricasOds04(Integer indicadorId) { return findMedicionesByIndicador(indicadorId); }
