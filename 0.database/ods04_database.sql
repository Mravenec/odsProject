...
-- Crear base de datos ODS04 (sin sistema de login)
...
CREATE TABLE proyectos (
    ...
    objetivo_id INT NOT NULL DEFAULT 4, -- Solo ODS04
    descripcion TEXT,
...
CREATE TABLE metas_proyecto (
    ...
    meta_codigo VARCHAR(10) NOT NULL, -- 4.1, 4.2, etc.
...
CREATE TABLE indicadores (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proyecto_id INT NOT NULL,
    indicador_codigo VARCHAR(10) NOT NULL, -- 4.1.1, 4.1.2, etc.
...
-- VISTA PARA ADMINISTRADOR: Estadísticas Generales ODS04
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.1.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_1_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.2.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_2_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.3.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_3_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.4.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_4_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.5.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_5_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.6.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_6_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.7.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_7_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.a.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_a_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.b.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_b_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '4.c.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_4_c_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 4;
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 4 AND estado = 'activo'
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 4 AND estado = 'completado'
