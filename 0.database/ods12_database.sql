...
-- Crear base de datos ODS12 (sin sistema de login)
...
CREATE TABLE proyectos (
    ...
    objetivo_id INT NOT NULL DEFAULT 12, -- Solo ODS12
    descripcion TEXT,
...
CREATE TABLE metas_proyecto (
    ...
    meta_codigo VARCHAR(10) NOT NULL, -- 12.1, 12.2, etc.
...
CREATE TABLE indicadores (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proyecto_id INT NOT NULL,
    indicador_codigo VARCHAR(10) NOT NULL, -- 12.1.1, 12.2.1, etc.
...
-- VISTA PARA ADMINISTRADOR: Estadísticas Generales ODS12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.1.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_1_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.2.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_2_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.3.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_3_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.4.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_4_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    '12.5' as meta_codigo,
    'Reducir generación desechos reciclado reutilización' as meta_descripción,
    COUNT(DISTINCT p.id) as total_proyectos,
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.5.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_5_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.6.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_6_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.7.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_7_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.8.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_8_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    '12.a' as meta_codigo,
    'Fortalecer capacidad científica tecnológica países en desarrollo' as meta_descripción,
    COUNT(DISTINCT p.id) as total_proyectos,
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.a.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_a_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    '12.b' as meta_codigo,
    'Aplicar instrumentos contabilidad turismo sostenible' as meta_descripción,
    COUNT(DISTINCT p.id) as total_proyectos,
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.b.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_b_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12
...
SELECT 
    '12.c' as meta_codigo,
    'Racionalizar subsidios ineficientes combustibles fósiles' as meta_descripción,
    COUNT(DISTINCT p.id) as total_proyectos,
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '12.c.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_12_c_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 12;
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 12 AND estado = 'activo'
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 12 AND estado = 'completado'
