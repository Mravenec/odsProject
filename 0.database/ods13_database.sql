...
-- Crear base de datos ODS13 (sin sistema de login)
...
CREATE TABLE proyectos (
    ...
    objetivo_id INT NOT NULL DEFAULT 13, -- Solo ODS13
    descripcion TEXT,
...
CREATE TABLE metas_proyecto (
    ...
    meta_codigo VARCHAR(10) NOT NULL, -- 13.1, 13.2, etc.
...
CREATE TABLE indicadores (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proyecto_id INT NOT NULL,
    indicador_codigo VARCHAR(10) NOT NULL, -- 13.1.1, 13.1.2, etc.
...
-- VISTA PARA ADMINISTRADOR: Estadísticas Generales ODS13
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '13.1.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_13_1_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 13
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '13.2.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_13_2_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 13
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '13.3.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_13_3_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 13
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '13.4.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_13_4_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 13
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '13.a.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_13_a_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 13
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '13.b.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_13_b_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 13;
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 13 AND estado = 'activo'
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 13 AND estado = 'completado'
