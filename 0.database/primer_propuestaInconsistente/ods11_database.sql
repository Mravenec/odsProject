...
-- Crear base de datos ODS11 (sin sistema de login)
...
CREATE TABLE proyectos (
    ...
    objetivo_id INT NOT NULL DEFAULT 11, -- Solo ODS11
    descripcion TEXT,
...
CREATE TABLE metas_proyecto (
    ...
    meta_codigo VARCHAR(10) NOT NULL, -- 11.1, 11.2, etc.
...
CREATE TABLE indicadores (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proyecto_id INT NOT NULL,
    indicador_codigo VARCHAR(10) NOT NULL, -- 11.1.1, 11.2.1, etc.
...
-- VISTA PARA ADMINISTRADOR: Estadísticas Generales ODS11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.1.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_1_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.2.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_2_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.3.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_3_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.4.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_4_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.5.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_5_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.6.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_6_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.7.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_7_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.a.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_a_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.b.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_b_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '11.c.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_11_c_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 11;
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 11 AND estado = 'activo'
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 11 AND estado = 'completado'
