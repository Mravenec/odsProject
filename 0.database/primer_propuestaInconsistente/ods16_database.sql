...
-- Crear base de datos ODS16 (sin sistema de login)
...
CREATE TABLE proyectos (
    ...
    objetivo_id INT NOT NULL DEFAULT 16, -- Solo ODS16
    descripcion TEXT,
...
CREATE TABLE metas_proyecto (
    ...
    meta_codigo VARCHAR(10) NOT NULL, -- 16.1, 16.2, etc.
...
CREATE TABLE indicadores (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proyecto_id INT NOT NULL,
    indicador_codigo VARCHAR(10) NOT NULL, -- 16.1.1, 16.1.2, etc.
...
-- VISTA PARA ADMINISTRADOR: Estadísticas Generales ODS16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.1.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_1_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.2.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_2_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.3.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_3_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.4.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_4_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.5.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_5_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.6.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_6_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.8.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_8_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.9.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_9_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '16.10.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_16_10_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 16;
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 16 AND estado = 'activo'
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 16 AND estado = 'completado'
