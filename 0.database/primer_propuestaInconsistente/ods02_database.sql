...
-- Crear base de datos ODS02 (sin sistema de login)
...
CREATE TABLE proyectos (
    ...
    objetivo_id INT NOT NULL DEFAULT 2, -- Solo ODS02
    descripcion TEXT,
...
CREATE TABLE metas_proyecto (
    ...
    meta_codigo VARCHAR(10) NOT NULL, -- 2.1, 2.2, etc.
...
CREATE TABLE indicadores (
    id INT AUTO_INCREMENT PRIMARY KEY,
    proyecto_id INT NOT NULL,
    indicador_codigo VARCHAR(10) NOT NULL, -- 2.1.1, 2.1.2, etc.
...
-- VISTA PARA ADMINISTRADOR: Estadísticas Generales ODS02
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.1.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_1_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.2.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_2_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.3.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_3_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.4.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_4_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.5.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_5_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.a.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_a_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.b.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_b_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2
...
SELECT 
    ...
    COUNT(DISTINCT CASE WHEN i.indicador_codigo LIKE '2.c.%' AND i.valor_actual >= i.valor_meta THEN i.id END) as indicadores_2_c_logrados
FROM proyectos p
LEFT JOIN indicadores i ON p.id = i.proyecto_id
WHERE p.objetivo_id = 2;
...
BEGIN
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 2 AND estado = 'activo'
    ...
    SELECT 
        ...
        COUNT(*) as valor
    FROM proyectos 
    WHERE objetivo_id = 2 AND estado = 'completado'
